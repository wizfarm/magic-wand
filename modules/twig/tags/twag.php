<?php
namespace MagicWand\Modules\Twig\Tags;

//use Elementor\Core\DynamicTags\Tag;
use \Elementor\Controls_Manager;
use MagicWand\Core\Utils;
use Elementor\Modules\DynamicTags\Module;
//use MagicWand\Base\Base_Tag;
...
class Twag extends \Elementor\Core\DynamicTags\Tag {
    ...
    public function get_title() {
        return esc_html__('Twig', 'magic-wand');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
                'e_twig',
                [
                    'label' => esc_html__('Twig', 'magic-wand'),
        ...
        $this->add_control(
                'e_twig_data',
                [
                    'label' => esc_html__('Return as Structured Data', 'magic-wand'),
                    'type' => \Elementor\Controls_Manager::SWITCHER,
                    'description' => '<small>'. esc_html__('Required for MEDIA Controls and other Controls which need a structured data', 'magic-wand').'</small>',
                ]
        );
