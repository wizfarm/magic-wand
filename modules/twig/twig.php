...
namespace MagicWand\Modules\Twig;

use MagicWand\Core\Utils;
use MagicWand\Base\Module_Base;
...
class Twig extends Module_Base {
    ...
    public static function do_twig($string = '', $data = array(), $var = '') {
        ...
        $data = apply_filters('magic-wand/data', $data);
    ...
    public function add_timber_filters($filters) {
        ...
        $customs = [
            ...
            //'form_options' => [ 'callable' => function ($arr) { return \MagicWand\Core\Utils\Form::array_to_options($arr, 'pro', $format); } ],
