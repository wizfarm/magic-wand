...
namespace MagicWand\Core\Managers;
...
final class Modules {
    ...
    public function __construct() {
        ...
        $modules = $this->find_modules(MAGIC_WAND_PATH);
        $this->add_modules($modules);

        do_action('magic-wand/modules');
    }
    ...
    public function add_modules($modules = array(), $domain = 'MagicWand') {
